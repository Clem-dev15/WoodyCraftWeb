    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        @else
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-semibold mb-3">Supprimer un article</h3>

                    <div class="space-y-2">
                        @foreach($panier as $item)
                            <form action="{{ route('panier.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet article ?');">
                                @csrf
                                @method('DELETE')
